    ...
    public void afiseazasolicitari(List<Solicitare> solicitari) {
        if (solicitari.isEmpty()) {
            ...
            for (Solicitare solicitare : solicitari)  {
                System.out.println("\nSolicitare pentru clientul " + solicitare.getClient().getNume() + " - Stare: " + solicitare.getState());
                System.out.println("Adresa: " + solicitare.getAdresa());
                System.out.println("Animal: " + solicitare.getAnimal().getNume());
...
public void filtreazaDupaStare(List<Solicitare> solicitari) {
    System.out.print("Introduceti starea solicitarii pentru filtrare (In analiza, Acceptata, Echipaj Plecat, Respinsa): ");
    scanner.nextLine();  // Consuma newline-ul
